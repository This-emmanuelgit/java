...
public class DonorMain {
				...
				case 2:
					...
					while (true) {
						if (donorServiceImpl.validateDonorId(donorId)) {
							...
							System.err.println("Please enter numeric donor id only, try again");
							donorId = sc.next();
						}
					}
					...
					if (donorBean != null) {
						System.out.println("Name             			:" + donorBean.getDonorName());
						System.out.println("Address        			    :" + donorBean.getAddress());
						System.out.println("Phone Number    		    :" + donorBean.getPhoneNumber());
						System.out.println("Donor Date     			    :" + donorBean.getDonationDate());
						System.out.println("Donation Amount(in Rupees)  :" + donorBean.getDonationAmount());
					} else {
						System.err.println("There are no donation details associated with donor id " + donorId);
					}
				...
				case 3:
					...
					try {
						...
						if (donorList != null) {
							...
							System.out.println("Nobody has made a donation, yet.");
						}
	...
	/*
	 * This function will call the service layer method and return the bean object
	 * which is populated by the information of the given donorId in parameter
	 */
	...
	/*
	 * This function will be called by main and will return a validated bean object
	 * OR null if details are invalid
	 */
